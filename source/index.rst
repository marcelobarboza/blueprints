.. Plano de Ensino documentation master file, created by
...
Série de Potências; Resíduos e Pólos; Aplicações.
...
disponibilizado no plano semanal de trabalho do professor.

Critérios de Avaliação
----------------------

A nota final de cada discente, :math:`N_f` em símbolos, será composta de:
...
O *seminário* constará de uma apresentação oral e individual, com duração
máxima de 25 minutos. O tema da apresentação será sorteado com antecedência
mínima de uma e máxima de duas semanas, tendo-se como referência a data de
apresentação.

A lista de temas para o sorteio dos seminários terá tantos itens quantos forem
os alunos inicialmente matriculados na disciplina e será previamente
disponibilizada pelo Professor, de acordo com o cronograma deste plano de
ensino. Na ocasião do sorteio do tema, também será sorteado, pelo número de
matrícula, o discente a apresentar aquele tema.
...
- Aprovado: caso MF seja maior ou igual a 6,0;

- Reprovado: caso MF seja menor que 6,0.

Cronograma
----------

.. csv-table::
   :header: "Data", "Qtd de aulas", "Assunto"
   :widths: 4, 8, 30
